    ...
    <footer>
      <Container className="flex flex-col items-center justify-between gap-8 py-3">
        {/* <div className="flex items-center justify-start gap-4">
          ...
          >
            <Twitter className=" text-active dark:text-active_dark w-4 svg" />
            <span className="text-[0.9rem]">Twitter</span>
            <span>
              <ExternalLink className=" text-active dark:text-active_dark w-4" />
            </span>
          </a>
          <a
          ...
          >
            <Linkedin
              className=" text-active dark:text-active_dark w-4 svg"
              fill="text-active dark:text-active_dark"
            />
          ...
          >
            <svg
              className=" text-active dark:text-active_dark w-4"
              fill="text-active dark:text-active_dark"
              viewBox="0 0 24 24"
              aria-hidden="true"
            >
        ...
        <p className="text-[0.85rem] text-inactive dark:text-inactive_dark">
          &copy; All rights reserved | Benedict {new Date().getFullYear()}
        </p>
      </Container>
    </footer>
  );
